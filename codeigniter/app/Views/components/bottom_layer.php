<footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
  <div class="mx-auto max-w-screen-xl text-center">
      <a href="#" class="flex justify-center items-center text-2xl font-semibold text-gray-900 dark:text-white">
          ...
          <?php echo getenv('company_name') ?>
      </a>
      <p class="my-6 text-gray-500 dark:text-gray-400">Accelerate development and streamline your workflows with our comprehensive suite of tools and solutions.</p>
...
<div id="info-popup" tabindex="-1" class="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
    <div class="relative p-4 w-full max-w-lg h-full md:h-auto">
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 md:p-8">
            <div id="modal-content" class="mb-4 text-sm font-light text-gray-500 dark:text-gray-400">
                <h3 id="modal-title" class="mb-3 text-2xl font-bold text-gray-900 dark:text-white">Database Connection Status</h3>
                <p id="modal-message">
                <?php echo $message ?>
                </p>
            </div>
